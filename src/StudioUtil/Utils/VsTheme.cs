...
namespace StudioUtil.Utils
{
    public static class VsTheme
    {
        ...
        private static ResourceDictionary BuildThemeResources()
        {
            ...
            {
                var shellResources =
                    (ResourceDictionary) Application.LoadComponent(new Uri("Microsoft.VisualStudio.Platform.WindowManagement;component/Themes/ThemedDialogDefaultStyles.xaml", UriKind.Relative));
